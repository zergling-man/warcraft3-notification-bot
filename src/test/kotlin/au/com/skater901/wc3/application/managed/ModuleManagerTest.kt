...
class ModuleManagerTest {
    ...
    fun `should validate module names are unique`() {
        ...
        assertThatThrownBy { moduleManager.initializeModules(injector) }
            ...
            .hasMessage("Multiple modules registered with name [ module2 ]: au.com.skater901.wc3.application.managed.ModuleManagerTest.DuplicateModule1, au.com.skater901.wc3.application.managed.ModuleManagerTest.DuplicateModule2. Multiple modules registered with name [ module3 ]: au.com.skater901.wc3.application.managed.ModuleManagerTest.DuplicateModule3, au.com.skater901.wc3.application.managed.ModuleManagerTest.DuplicateModule4.")
    }
